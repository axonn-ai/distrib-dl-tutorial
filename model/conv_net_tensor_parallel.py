...
class FCNetLayer(nn.Module):
    def __init__(self, input_size, hidden_size, output_size):
        ...
        self.linear_2 = Linear(in_features = hidden_size, out_features = output_size, init_method = init_method_normal())
...
class ConvLayer(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size):
        ...
        #self.conv2d_1 = nn.Conv2d(in_channels = in_channels[0], out_channels = out_channels[0], kernel_size = kernel_size[0],)# init_method = init_method_normal()) 
        self.relu = nn.ReLU()

        ## every alternate layer needs to be 'transposed'
        self.conv2d_2 = Tensor_Parallel_Conv2d(in_channels = in_channels[1], out_channels = out_channels[1], kernel_size = kernel_size[1], init_method = init_method_normal())
        #self.conv2d_2 = nn.Conv2d(in_channels = in_channels[1], out_channels = out_channels[1], kernel_size = kernel_size[1],)# init_method = init_method_normal())
